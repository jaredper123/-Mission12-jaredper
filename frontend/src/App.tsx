...
import './App.css';
/*This code should be uploaded with this simple addition */
...
function Title() {
    return (<h1>Welcome to March Madness Teams Info</h1>);
}

class Team extends React.Component  <{ "name": string; "school": string; "city": string; "state": string }>
{
    render() {
        const marchTeam = this.props;

        return (
            <div className="card">
                <h2>School: {marchTeam.school}</h2>
                <p>Name: {marchTeam.name}</p>
                <p>City: {marchTeam.city}</p>
                <p>State: {marchTeam.state}</p>
            </div>
...
function TeamList() {
    return (
        <div>
            {teams.map(marchTeam => <Team {...marchTeam}/>)}
        </div>
    );
}
